    ...
    <el-tabs v-model="activeTab">
      <el-tab-pane label="动态库" name="library">
        ...
        <el-pagination v-model:current-page="libQuery.current" v-model:page-size="libQuery.size"
          :total="libTotal" :page-sizes="[10,20,50]" layout="total,sizes,prev,pager,next" @current-change="loadLib" @size-change="loadLib" />
      </el-tab-pane>
      ...
      <el-tab-pane label="总使用频率" name="totalFreq">
        ...
        <el-pagination v-model:current-page="freqQuery.current" v-model:page-size="freqQuery.size"
          :total="freqTotal" :page-sizes="[10,20,50]" layout="total,sizes,prev,pager,next" @current-change="loadFreq" @size-change="loadFreq" />
      </el-tab-pane>
      ...
      <el-tab-pane label="串口使用频率" name="serialFreq">
        ...
        <el-pagination v-model:current-page="serialQuery.current" v-model:page-size="serialQuery.size"
          :total="serialTotal" :page-sizes="[10,20,50]" layout="total,sizes,prev,pager,next" @current-change="loadSerial" @size-change="loadSerial" />
      </el-tab-pane>
    </el-tabs>
